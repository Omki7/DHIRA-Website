  ...
  return (
    <div className="mt-4 flex max-w-[26em] items-center gap-3 rounded-[12px] border border-subtle-stroke bg-white px-3.5 py-2.5 shadow-card">
      ...
      <div className="min-w-0 flex-1">
        <div className="truncate text-[12px] font-semibold text-ink">District lead · notified</div>
      ...
      <div className="rail-container pt-12 pb-24 lg:pt-16 lg:pb-32">
        ...
        <div className="mt-14 grid gap-12 lg:mt-16 lg:grid-cols-[minmax(0,5fr)_minmax(0,7fr)] lg:gap-20">
          ...
          <div className="relative">
            <div
              className="absolute left-[19px] top-8 bottom-8 w-px bg-gradient-to-b from-blue-border via-lineSoft to-blue-border"
              aria-hidden
            />
            {moves.map((move, i) => (
              <ScrollReveal key={move.name} delay={i * 90}>
                <div className="relative grid grid-cols-[40px_1fr] gap-x-6 py-7 first:pt-0 last:pb-0">
                  <div className="relative z-10 flex h-10 w-10 items-center justify-center rounded-full border border-blue-border bg-blue-subtle font-mono text-[11px] font-medium text-blue">
                    0{i + 1}
                  </div>
                  <div>
