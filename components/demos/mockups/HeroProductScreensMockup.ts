...
export function appTopBar(section: string, page: string) {
  return `<div style="height:42px;border-bottom:1px solid #E9EAEE;display:flex;align-items:center;padding:0 14px;gap:9px;flex-shrink:0;background:#fff">
    ...
    <span style="font-size:11px;color:#C4C5C9">/</span><span style="font-size:11px;color:#5C5E63;cursor:pointer">${section}</span>
    ...
    <div style="position:relative;width:26px;height:26px;border-radius:7px;border:1px solid #E9EAEE;background:#fff;display:flex;align-items:center;justify-content:center;flex-shrink:0;cursor:pointer" title="Notifications">
      ...
      <span style="position:absolute;top:-5px;right:-5px;min-width:13px;height:13px;border-radius:7px;background:#E5547B;border:1.5px solid #fff;display:flex;align-items:center;justify-content:center;font-size:7.5px;color:#fff;font-weight:700;padding:0 2px;line-height:1">3</span>
    </div>
    <div style="display:flex;align-items:center;gap:3px;flex-shrink:0;cursor:pointer" title="Account">
      ...
      <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="#8E8F91" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>
    </div>
  </div>`;
}
...
export function moduleRail(active: string) {
  const items = RAIL_ICONS.map(([key, paths]) => {
    ...
    return `<div style="position:relative;width:30px;height:30px;border-radius:8px;display:flex;align-items:center;justify-content:center;flex-shrink:0;${on ? "background:#EEF1FC;" : ""}cursor:pointer">${on ? `<span style="position:absolute;left:-8px;top:7px;width:3px;height:16px;border-radius:0 2px 2px 0;background:#3E63DD"></span>` : ""}${svg}</div>`;
  }).join("");
  return `<div style="width:46px;border-right:1px solid #E9EAEE;background:#FBFBFC;display:flex;flex-direction:column;align-items:center;padding:9px 0 10px;gap:4px;flex-shrink:0">
    <div style="width:28px;height:28px;border-radius:8px;background:linear-gradient(135deg,#1A1C1D,#3E4147);display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0" title="DHIRA workspace"><span style="font-size:10px;color:#fff;font-weight:700;letter-spacing:0.02em">DH</span></div>
    <div style="width:22px;height:1px;background:#E9EAEE;margin:2px 0 3px;flex-shrink:0"></div>
    ${items}
    <div style="flex:1"></div>
    <div style="width:30px;height:30px;border-radius:8px;display:flex;align-items:center;justify-content:center;cursor:pointer" title="Help & docs"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#8E8F91" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M9.1 9a3 3 0 0 1 5.8 1c0 2-3 2.4-3 4"/><path d="M12 17h.01"/></svg></div>
    <div style="width:30px;height:30px;border-radius:8px;display:flex;align-items:center;justify-content:center;cursor:pointer" title="Settings"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#8E8F91" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M12 1v3M12 20v3M4.2 4.2l2.1 2.1M17.7 17.7l2.1 2.1M1 12h3M20 12h3M4.2 19.8l2.1-2.1M17.7 6.3l2.1-2.1"/></svg></div>
  </div>`;
}
...
/* ---------------------------------------------------------------- */
export const PIPELINES_SCREEN_HTML = `<div style="width:100%;height:100%;display:flex;flex-direction:column;font-family:var(--font-sans);background:#FAFAFB">
  ${WINDOW_BAR}
  ...
  <div style="flex:1;display:flex;overflow:hidden">
    ...
    <div style="flex:1;display:flex;flex-direction:column;min-width:0;overflow:hidden">
      <div style="height:40px;border-bottom:1px solid #E9EAEE;display:flex;align-items:center;padding:0 14px;gap:10px;flex-shrink:0;background:#fff">
        <span style="font-size:12px;font-weight:700;color:#1A1C1D;letter-spacing:-0.01em;white-space:nowrap">Sales Performance</span>
        ...
        <div style="width:1px;height:18px;background:#E9EAEE"></div>
        <div style="height:24px;padding:0 9px;background:#EAF7F0;border:1px solid #CBE8D9;border-radius:20px;display:flex;align-items:center;gap:5px;flex-shrink:0"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#1F9D6B" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg><span style="font-size:10.5px;color:#1B8A5F;font-weight:600">Verified</span></div>
        <div style="height:27px;padding:0 10px;border:1px solid #E9EAEE;border-radius:7px;background:#fff;display:flex;align-items:center;gap:6px;cursor:pointer;flex-shrink:0"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#5C5E63" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M8 2v4M16 2v4M3 10h18"/></svg><span style="font-size:11.5px;color:#5C5E63;font-weight:500">Schedule: Hourly</span><svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="#8E8F91" stroke-width="3" stroke-linecap="round"><path d="m6 9 6 6 6-6"/></svg></div>
        <div style="flex:1"></div>
        ...
        <div style="width:200px;border-right:1px solid #E9EAEE;display:flex;flex-direction:column;flex-shrink:0;background:#fff">
          ...
          <div style="flex:1;overflow:hidden;padding:0 9px">
            ...
            <div style="display:flex;flex-direction:column;gap:1px">
              ...
              <div style="display:flex;align-items:center;gap:8px;padding:5px 7px;border-radius:7px;background:#F6F6F7"><svg width="7" height="11" viewBox="0 0 8 12" fill="#C4C5C9" style="flex-shrink:0;margin-right:-3px"><circle cx="2" cy="2" r="1"/><circle cx="6" cy="2" r="1"/><circle cx="2" cy="6" r="1"/><circle cx="6" cy="6" r="1"/><circle cx="2" cy="10" r="1"/><circle cx="6" cy="10" r="1"/></svg><div style="width:19px;height:19px;border-radius:5px;background:#1F2A52;display:flex;align-items:center;justify-content:center;flex-shrink:0"><span style="font-size:9px;color:#fff;font-weight:700">N</span></div><span style="font-size:11.5px;color:#1A1C1D">NetSuite</span><div style="flex:1"></div><span style="font-size:9px;color:#8E8F91">ERP</span></div>
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;padding:9px 3px 4px"><span style="display:inline-flex;align-items:center;gap:4px;font-size:9.5px;font-weight:700;color:#8E8F91;letter-spacing:0.07em;cursor:pointer"><svg width="8" height="8" viewBox="0 0 24 24" fill="none" stroke="#B4BAC2" stroke-width="3.2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>FILES &amp; SHEETS</span><span style="font-size:9px;color:#8E8F91;background:#F3F3F4;border-radius:5px;padding:0 5px;font-weight:600">2</span></div>
            <div style="display:flex;flex-direction:column;gap:1px">
              <div style="display:flex;align-items:center;gap:8px;padding:5px 7px;border-radius:7px"><div style="width:19px;height:19px;border-radius:5px;background:#1E7A45;display:flex;align-items:center;justify-content:center;flex-shrink:0"><span style="font-size:9px;color:#fff;font-weight:700">X</span></div><span style="font-size:11.5px;color:#1A1C1D">Sales Plan FY26</span><div style="flex:1"></div><span style="font-size:9px;color:#8E8F91">Excel</span></div>
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;padding:9px 3px 4px"><span style="display:inline-flex;align-items:center;gap:4px;font-size:9.5px;font-weight:700;color:#8E8F91;letter-spacing:0.07em;cursor:pointer"><svg width="8" height="8" viewBox="0 0 24 24" fill="none" stroke="#B4BAC2" stroke-width="3.2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>DATABASES</span><span style="font-size:9px;color:#8E8F91;background:#F3F3F4;border-radius:5px;padding:0 5px;font-weight:600">2</span></div>
            <div style="display:flex;flex-direction:column;gap:1px">
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;padding:9px 3px 4px"><span style="display:inline-flex;align-items:center;gap:4px;font-size:9.5px;font-weight:700;color:#8E8F91;letter-spacing:0.07em;cursor:pointer"><svg width="8" height="8" viewBox="0 0 24 24" fill="none" stroke="#B4BAC2" stroke-width="3.2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>STREAMING</span><span style="font-size:9px;color:#8E8F91;background:#F3F3F4;border-radius:5px;padding:0 5px;font-weight:600">1</span></div>
            <div style="display:flex;flex-direction:column;gap:1px">
        ...
        <div style="flex:1;position:relative;overflow:hidden;background:#fff;background-image:radial-gradient(circle,#E9E9EB 1px,transparent 1px);background-size:22px 22px">
          <svg width="674" height="482" viewBox="0 0 674 482" style="position:absolute;top:0;left:0;pointer-events:none">
            ...
            <g font-family="ui-monospace,SFMono-Regular,Menlo,monospace" font-size="9">
              ...
              <rect x="413.5" y="262.5" width="41" height="15" rx="7.5" fill="#fff" stroke="#E9EAEE"/><text x="434" y="273.5" text-anchor="middle" fill="#5C5E63">82.4k</text>
            </g>
          </svg>
          <div style="position:absolute;top:12px;left:18px;width:154px;text-align:center"><span style="font-size:9px;font-weight:700;color:#8E8F91;letter-spacing:0.08em;font-family:var(--font-mono)">SOURCES · 3</span></div>
          <div style="position:absolute;top:12px;left:254px;width:158px;text-align:center"><span style="font-size:9px;font-weight:700;color:#8E8F91;letter-spacing:0.08em;font-family:var(--font-mono)">TRANSFORM · 1</span></div>
          <div style="position:absolute;top:12px;left:460px;width:150px;text-align:center"><span style="font-size:9px;font-weight:700;color:#8E8F91;letter-spacing:0.08em;font-family:var(--font-mono)">OUTPUTS · 2</span></div>
          ...
          <div style="position:absolute;left:254px;top:176px;width:158px;background:#fff;border:1.5px solid #3E63DD;border-radius:11px;box-shadow:0 2px 8px rgba(62,99,221,0.14)">
            ...
            <div style="padding:7px 11px 8px;display:flex;flex-direction:column;gap:4px">
              ...
              <div style="display:flex;align-items:center;gap:6px"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#8E8F91" stroke-width="2" stroke-linecap="round"><path d="M9 17H7A5 5 0 0 1 7 7h2M15 7h2a5 5 0 1 1 0 10h-2M8 12h8"/></svg><span style="font-size:10px;color:#5C5E63">Invoices</span><div style="flex:1"></div><span style="font-size:9px;color:#1A1C1D;font-family:var(--font-mono)">order_no</span></div>
              <div style="display:flex;align-items:center;gap:6px"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#8E8F91" stroke-width="2" stroke-linecap="round"><path d="M9 17H7A5 5 0 0 1 7 7h2M15 7h2a5 5 0 1 1 0 10h-2M8 12h8"/></svg><span style="font-size:10px;color:#5C5E63">Plan</span><div style="flex:1"></div><span style="font-size:9px;color:#1A1C1D;font-family:var(--font-mono)">region + month</span></div>
              <span style="font-size:9px;font-weight:700;color:#3E63DD;letter-spacing:0.05em;padding-top:3px">OUTPUT</span>
              <div style="display:flex;align-items:baseline"><span style="font-size:9.5px;color:#1A1C1D;font-weight:600;font-family:var(--font-mono)">fact_sales</span><span style="font-size:9.5px;color:#5C5E63"> · 1 row per sale</span></div>
            </div>
          ...
          <div style="position:absolute;left:460px;top:294px;width:150px;background:#fff;border:1px solid #E9EAEE;border-radius:10px;box-shadow:0 1px 2px rgba(18,20,26,0.05);padding:9px 11px;display:flex;align-items:center;gap:9px">
            ...
            <div style="min-width:0"><div style="font-size:11.5px;font-weight:600;color:#1A1C1D">Quality checks</div><div style="font-size:9.5px;color:#5C5E63">23 passing · <b style="color:#A97B12;font-weight:600">1 warning</b></div></div>
          </div>
...
/* ---------------------------------------------------------------- */
export const ASK_SCREEN_HTML = `<div style="width:100%;height:100%;display:flex;flex-direction:column;font-family:var(--font-sans);background:#FAFAFB">
  ${WINDOW_BAR}
            ...
            <div style="display:flex;gap:10px;align-items:flex-start">
              ...
              <div style="flex:1;min-width:0;background:#fff;border:1px solid #E9EAEE;border-radius:12px;padding:12px 14px">
                ...
                <div style="display:flex;align-items:center;gap:7px;margin-bottom:8px;padding:5px 11px;background:#FAFAFB;border:1px solid #EEEFF1;border-radius:9px;flex-wrap:wrap">
                  ...
                  <span style="font-size:9px;color:#8E8F91;font-family:var(--font-mono)">revenue: warehouse · targets: parsed from PDF p.8</span>
                  <div style="flex:1"></div>
                ...
                <div style="border:1px solid #E9EAEE;border-radius:12px;padding:9px 13px;margin-bottom:9px;background:#fff">
                  ...
                  <div style="display:flex;align-items:center;justify-content:space-between;margin-top:6px;padding-top:6px;border-top:1px solid #F1F2F5">
                    <span style="font-size:9px;color:#8E8F91;font-family:var(--font-mono)">plan_attainment · metric layer</span>
                    <span style="font-size:9px;color:#8E8F91">dashed ring = 100% target · refreshed 6m ago</span>
                  </div>
                </div>
...
/* ---------------------------------------------------------------- */
export const MODELS_SCREEN_HTML = `<div style="width:100%;height:100%;display:flex;flex-direction:column;font-family:var(--font-sans);background:#FAFAFB">
  ${WINDOW_BAR}
  ...
  <div style="flex:1;display:flex;overflow:hidden">
    ...
    <div style="flex:1;display:flex;flex-direction:column;min-width:0;overflow:hidden">
      <div style="height:40px;border-bottom:1px solid #E9EAEE;display:flex;align-items:center;padding:0 14px;gap:10px;flex-shrink:0;background:#fff">
        <span style="font-size:12px;font-weight:700;color:#1A1C1D;letter-spacing:-0.01em;white-space:nowrap">Sales Performance</span>
        <div style="width:1px;height:18px;background:#E9EAEE"></div>
        <div style="height:27px;padding:0 11px;background:#1A1C1D;border-radius:7px;display:flex;align-items:center;gap:6px;cursor:pointer;flex-shrink:0"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12h14"/></svg><span style="font-size:11.5px;color:#fff;font-weight:600">Add table</span></div>
        <div style="display:flex;align-items:center;height:27px;background:#F3F3F4;border-radius:8px;padding:2px;flex-shrink:0">
      ...
      <div style="flex:1;display:flex;overflow:hidden">
        <div style="width:200px;border-right:1px solid #E9EAEE;display:flex;flex-direction:column;flex-shrink:0;background:#fff">
          ...
          <div style="flex:1;overflow:hidden;padding:0 9px">
            <div style="display:flex;align-items:center;gap:6px;padding:6px 3px 4px"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#1F9D6B" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19V5M4 12h7M11 5v14M18 8v8"/></svg><span style="display:inline-flex;align-items:center;gap:4px;font-size:9.5px;font-weight:700;color:#8E8F91;letter-spacing:0.06em;cursor:pointer"><svg width="8" height="8" viewBox="0 0 24 24" fill="none" stroke="#B4BAC2" stroke-width="3.2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>METRICS</span><div style="flex:1"></div><span style="font-size:9px;color:#8E8F91;background:#F3F3F4;border-radius:5px;padding:0 5px;font-weight:600">3</span><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#8E8F91" stroke-width="2.4" stroke-linecap="round" style="cursor:pointer;margin-left:6px;flex-shrink:0"><path d="M12 5v14M5 12h14"/></svg></div>
            <div style="display:flex;flex-direction:column;gap:1px">
              ...
              <div style="display:flex;align-items:center;gap:8px;padding:5px 7px;border-radius:7px;background:#F6F6F7"><div style="width:18px;height:18px;border-radius:5px;background:#EAF7F0;display:flex;align-items:center;justify-content:center;flex-shrink:0"><span style="font-size:11px;color:#1F9D6B;font-weight:700">∑</span></div><span style="font-size:11.5px;color:#1A1C1D;font-weight:500;white-space:nowrap">Units Sold</span><div style="flex:1"></div><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#1F9D6B" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg></div>
            ...
            <div style="display:flex;align-items:center;gap:6px;padding:11px 3px 4px"><svg width="11" height="11" viewBox="0 0 24 24" fill="#3E63DD" stroke="none"><rect x="3" y="3" width="18" height="18" rx="3"/></svg><span style="display:inline-flex;align-items:center;gap:4px;font-size:9.5px;font-weight:700;color:#8E8F91;letter-spacing:0.06em;cursor:pointer"><svg width="8" height="8" viewBox="0 0 24 24" fill="none" stroke="#B4BAC2" stroke-width="3.2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>FACTS</span><div style="flex:1"></div><span style="font-size:9px;color:#8E8F91;background:#F3F3F4;border-radius:5px;padding:0 5px;font-weight:600">1</span></div>
            <div style="display:flex;flex-direction:column;gap:1px">
            ...
            <div style="display:flex;align-items:center;gap:6px;padding:11px 3px 4px"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#7C5CFC" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="3"/></svg><span style="display:inline-flex;align-items:center;gap:4px;font-size:9.5px;font-weight:700;color:#8E8F91;letter-spacing:0.06em;cursor:pointer"><svg width="8" height="8" viewBox="0 0 24 24" fill="none" stroke="#B4BAC2" stroke-width="3.2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>DIMENSIONS</span><div style="flex:1"></div><span style="font-size:9px;color:#8E8F91;background:#F3F3F4;border-radius:5px;padding:0 5px;font-weight:600">4</span><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#8E8F91" stroke-width="2.4" stroke-linecap="round" style="cursor:pointer;margin-left:6px;flex-shrink:0"><path d="M12 5v14M5 12h14"/></svg></div>
            <div style="display:flex;flex-direction:column;gap:1px">
        ...
        <div style="flex:1;position:relative;overflow:hidden;background:#fff;background-image:radial-gradient(circle,#E9E9EB 1px,transparent 1px);background-size:22px 22px">
          ...
          <div style="position:absolute;left:22px;top:68px;width:150px;background:#fff;border:1px solid #E3DDFB;border-radius:10px;box-shadow:0 1px 2px rgba(18,20,26,0.04);overflow:hidden">
            ...
            <div style="padding:6px 11px 7px;display:flex;flex-direction:column;gap:5px">
              <div style="display:flex;align-items:center;gap:6px"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#C08A2D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="7.5" cy="15.5" r="5.5"/><path d="m21 2-9.6 9.6"/><path d="m15.5 7.5 3 3L22 7l-3-3"/></svg><span style="font-size:9.5px;color:#1A1C1D;font-family:var(--font-mono)">customer_id</span><div style="flex:1"></div><span style="font-size:9px;color:#C08A2D;font-weight:700">PK</span></div>
              <div style="display:flex;align-items:center;justify-content:space-between"><span style="font-size:10.5px;color:#1A1C1D">Name</span><span style="font-size:9px;color:#8E8F91;font-family:var(--font-mono)">text</span></div>
              <div style="display:flex;align-items:center;justify-content:space-between"><span style="font-size:10.5px;color:#1A1C1D">Segment</span><span style="font-size:9px;color:#8E8F91;font-family:var(--font-mono)">text</span></div>
              <div style="font-size:9px;color:#9787E0;padding-top:2px">synonyms: account, buyer</div>
            </div>
            <div style="border-top:1px solid #F1F2F5;background:#FAFAFB;padding:4px 11px;display:flex;align-items:center;gap:5px"><span style="width:5px;height:5px;border-radius:50%;background:#1F9D6B"></span><span style="font-size:9px;color:#5C5E63">12,447 rows · updated 6m ago</span></div>
          </div>
          <div style="position:absolute;left:22px;top:296px;width:150px;background:#fff;border:1px solid #E3DDFB;border-radius:10px;box-shadow:0 1px 2px rgba(18,20,26,0.04);overflow:hidden">
            ...
            <div style="padding:6px 11px 7px;display:flex;flex-direction:column;gap:5px">
              <div style="display:flex;align-items:center;gap:6px"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#C08A2D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="7.5" cy="15.5" r="5.5"/><path d="m21 2-9.6 9.6"/><path d="m15.5 7.5 3 3L22 7l-3-3"/></svg><span style="font-size:9.5px;color:#1A1C1D;font-family:var(--font-mono)">region_id</span><div style="flex:1"></div><span style="font-size:9px;color:#C08A2D;font-weight:700">PK</span></div>
              <div style="display:flex;align-items:center;justify-content:space-between"><span style="font-size:10.5px;color:#1A1C1D">Name</span><span style="font-size:9px;color:#8E8F91;font-family:var(--font-mono)">text</span></div>
              <div style="display:flex;align-items:center;justify-content:space-between"><span style="font-size:10.5px;color:#1A1C1D">Target</span><span style="font-size:9px;color:#8E8F91;font-family:var(--font-mono)">numeric</span></div>
              <div style="font-size:9px;color:#9787E0;padding-top:2px">synonyms: territory, market</div>
            </div>
            <div style="border-top:1px solid #F1F2F5;background:#FAFAFB;padding:4px 11px;display:flex;align-items:center;gap:5px"><span style="width:5px;height:5px;border-radius:50%;background:#1F9D6B"></span><span style="font-size:9px;color:#5C5E63">5 rows · updated 6m ago</span></div>
          </div>
          <div style="position:absolute;left:230px;top:118px;width:168px;background:#fff;border:1.5px solid #3E63DD;border-radius:11px;box-shadow:0 1px 3px rgba(62,99,221,0.12);overflow:hidden">
            ...
            <div style="padding:0 12px;display:flex;flex-direction:column;gap:4px">
              <div style="display:flex;align-items:center;gap:7px"><span style="width:14px;height:14px;border-radius:4px;background:#EAF7F0;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:9px;color:#1F9D6B;font-weight:700">∑</span><span style="font-size:10.5px;color:#1A1C1D;font-weight:500;white-space:nowrap">Revenue</span><div style="flex:1"></div><span style="font-size:9px;color:#5C5E63;font-family:var(--font-mono);white-space:nowrap">paid value</span></div>
              <div style="display:flex;align-items:center;gap:7px"><span style="width:14px;height:14px;border-radius:4px;background:#EAF7F0;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:9px;color:#1F9D6B;font-weight:700">∑</span><span style="font-size:10.5px;color:#1A1C1D;font-weight:500;white-space:nowrap">Units Sold</span><div style="flex:1"></div><span style="font-size:9px;color:#5C5E63;font-family:var(--font-mono);white-space:nowrap">count</span></div>
              <div style="display:flex;align-items:center;gap:7px"><span style="width:14px;height:14px;border-radius:4px;background:#EAF7F0;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:9px;color:#1F9D6B;font-weight:700">x̄</span><span style="font-size:10.5px;color:#1A1C1D;font-weight:500;white-space:nowrap">Discount</span><div style="flex:1"></div><span style="font-size:9px;color:#5C5E63;font-family:var(--font-mono);white-space:nowrap">avg</span></div>
            </div>
            ...
            <div style="padding:0 12px 10px;display:flex;flex-direction:column;gap:4px">
              <div style="display:flex;align-items:center;gap:7px"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#C08A2D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0"><circle cx="7.5" cy="15.5" r="5.5"/><path d="m21 2-9.6 9.6"/><path d="m15.5 7.5 3 3L22 7l-3-3"/></svg><span style="font-size:9.5px;color:#1A1C1D;font-family:var(--font-mono)">customer_id</span><div style="flex:1"></div><span style="font-size:9px;color:#8E8F91">→ Customer</span></div>
              <div style="display:flex;align-items:center;gap:7px"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#C08A2D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0"><circle cx="7.5" cy="15.5" r="5.5"/><path d="m21 2-9.6 9.6"/><path d="m15.5 7.5 3 3L22 7l-3-3"/></svg><span style="font-size:9.5px;color:#1A1C1D;font-family:var(--font-mono)">product_id</span><div style="flex:1"></div><span style="font-size:9px;color:#8E8F91">→ Product</span></div>
              <div style="display:flex;align-items:center;gap:7px"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#C08A2D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0"><circle cx="7.5" cy="15.5" r="5.5"/><path d="m21 2-9.6 9.6"/><path d="m15.5 7.5 3 3L22 7l-3-3"/></svg><span style="font-size:9.5px;color:#1A1C1D;font-family:var(--font-mono)">region_id</span><div style="flex:1"></div><span style="font-size:9px;color:#8E8F91">→ Region</span></div>
              <div style="display:flex;align-items:center;gap:7px"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#C08A2D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0"><circle cx="7.5" cy="15.5" r="5.5"/><path d="m21 2-9.6 9.6"/><path d="m15.5 7.5 3 3L22 7l-3-3"/></svg><span style="font-size:9.5px;color:#1A1C1D;font-family:var(--font-mono)">date_id</span><div style="flex:1"></div><span style="font-size:9px;color:#8E8F91">→ Date</span></div>
            </div>
            <div style="border-top:1px solid #E8EDFB;background:#FAFBFE;padding:4px 12px;display:flex;align-items:center;gap:5px"><span style="width:5px;height:5px;border-radius:50%;background:#1F9D6B"></span><span style="font-size:9px;color:#5C5E63">82,401 rows · updated 6m ago</span></div>
          </div>
          <div style="position:absolute;left:452px;top:68px;width:138px;background:#fff;border:1px solid #E3DDFB;border-radius:10px;box-shadow:0 1px 2px rgba(18,20,26,0.04);overflow:hidden">
            ...
            <div style="padding:6px 11px 7px;display:flex;flex-direction:column;gap:5px">
              <div style="display:flex;align-items:center;gap:6px"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#C08A2D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="7.5" cy="15.5" r="5.5"/><path d="m21 2-9.6 9.6"/><path d="m15.5 7.5 3 3L22 7l-3-3"/></svg><span style="font-size:9.5px;color:#1A1C1D;font-family:var(--font-mono)">product_id</span><div style="flex:1"></div><span style="font-size:9px;color:#C08A2D;font-weight:700">PK</span></div>
              <div style="display:flex;align-items:center;justify-content:space-between"><span style="font-size:10.5px;color:#1A1C1D">Name</span><span style="font-size:9px;color:#8E8F91;font-family:var(--font-mono)">text</span></div>
              <div style="display:flex;align-items:center;justify-content:space-between"><span style="font-size:10.5px;color:#1A1C1D">Category</span><span style="font-size:9px;color:#8E8F91;font-family:var(--font-mono)">text</span></div>
              <div style="font-size:9px;color:#9787E0;padding-top:2px">synonyms: item, SKU</div>
            </div>
            <div style="border-top:1px solid #F1F2F5;background:#FAFAFB;padding:4px 11px;display:flex;align-items:center;gap:5px"><span style="width:5px;height:5px;border-radius:50%;background:#1F9D6B"></span><span style="font-size:9px;color:#5C5E63">3,412 rows · updated 6m ago</span></div>
          </div>
          <div style="position:absolute;left:452px;top:296px;width:138px;background:#fff;border:1px solid #E3DDFB;border-radius:10px;box-shadow:0 1px 2px rgba(18,20,26,0.04);overflow:hidden">
            ...
            <div style="padding:6px 11px 7px;display:flex;flex-direction:column;gap:5px">
              <div style="display:flex;align-items:center;gap:6px"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#C08A2D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="7.5" cy="15.5" r="5.5"/><path d="m21 2-9.6 9.6"/><path d="m15.5 7.5 3 3L22 7l-3-3"/></svg><span style="font-size:9.5px;color:#1A1C1D;font-family:var(--font-mono)">date_id</span><div style="flex:1"></div><span style="font-size:9px;color:#C08A2D;font-weight:700">PK</span></div>
              <div style="display:flex;align-items:center;justify-content:space-between"><span style="font-size:10.5px;color:#1A1C1D">Quarter</span><span style="font-size:9px;color:#8E8F91;font-family:var(--font-mono)">text</span></div>
              <div style="display:flex;align-items:center;justify-content:space-between"><span style="font-size:10.5px;color:#1A1C1D">Fiscal Year</span><span style="font-size:9px;color:#8E8F91;font-family:var(--font-mono)">int</span></div>
              <div style="font-size:9px;color:#9787E0;padding-top:2px">synonyms: period, calendar</div>
            </div>
            <div style="border-top:1px solid #F1F2F5;background:#FAFAFB;padding:4px 11px;display:flex;align-items:center;gap:5px"><span style="width:5px;height:5px;border-radius:50%;background:#1F9D6B"></span><span style="font-size:9px;color:#5C5E63">1,096 rows · updated 6m ago</span></div>
          </div>
